...
INSERT INTO public.document_types_admedika (id, doc_code, doc_name, category, description, is_active, sort_order, created_at, updated_at) VALUES
(1, 'AL', 'Surat Pernyataan (Authorization Letter)', 'eForms', 'Authorization Letter', true, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'AP', 'Formulir Penjaminan Biaya (Approved Procedure Form)', 'eForms', 'Approved Procedure Form', true, 20, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'CL', 'Surat Konfirmasi Medis (Perkembangan, Lanjutan & Konsul)', 'eForms', 'Medical Confirmation Letter', true, 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 'DL', 'Surat Penolakan Jaminan Biaya (Decline Letter)', 'eForms', 'Decline Letter', true, 40, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 'FTDF', 'Fast Track Discharge Form', 'eForms', 'Fast Track Discharge Form', true, 50, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 'GL', 'Surat Jaminan Biaya (Guarantee Letter)', 'eForms', 'Guarantee Letter', true, 60, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(9, 'LABORATORIUM', 'Hasil Pemeriksaan Laboratorium', 'Edocs', 'Laboratory Test Results', true, 100, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10, 'RADIOLOGI', 'Hasil Pemeriksaan Radiology', 'Edocs', 'Radiology Results', true, 110, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11, 'INVOICE', 'Perincian Biaya - Pengobatan', 'Edocs', 'Invoice/Treatment Cost Details', true, 120, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 'BILLING', 'Billing Akhir - Jaminan Akhir Rawat Inap (Final Bill)', 'Edocs', 'Final Billing', true, 130, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(14, 'LEMBAR MEDIS AWAL', 'Resume Medis / Lembar Medis Awal', 'Edocs', 'Initial Medical Resume', true, 150, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(17, 'IDCARD', 'Kartu Identitas (Identification Card)', 'Edocs', 'Identification Card', true, 210, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(20, 'RESUMEMEDIS', 'Resume Medis', 'Edocs', 'Medical Resume', true, 320, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(23, 'SPTLAB', 'Surat Persetujuan Tindakan (Laboratorium)', 'Edocs', 'Laboratory Consent', true, 420, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 'SPTRAD', 'Surat Persetujuan Tindakan (Radiology)', 'Edocs', 'Radiology Consent', true, 430, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(25, 'SPTKONSUL', 'Konsultasi Dokter (Surat Persetujuan Tindakan)', 'Edocs', 'Doctor Consultation Consent', true, 440, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(27, 'BILLSEM', 'Billing Sementara - Perkiraan Biaya RI Sementara (Interim Bill)', 'Edocs', 'Interim Billing', true, 600, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 'BILLAKHIR', 'Billing Akhir - Jaminan Akhir Rawat Inap (Final Bill)', 'Edocs', 'Final Billing', true, 610, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(29, 'BIAYA_PENGOBATAN', 'Perincian Biaya - Pengobatan', 'Edocs', 'Treatment Cost Details', true, 620, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(30, 'OBAT_RACIKAN', 'Perincian Obat Obatan - Termasuk Racikan', 'Edocs', 'Medicine Details (Including Formulation)', true, 630, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(31, 'LOA_LOC', 'LOA / LOC (Printout Admedika)', 'Edocs', 'LOA/LOC Printout', true, 700, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(32, 'FORM_CLAIM', 'Formulir Klaim - Diisi Lengkap oleh Dokter', 'Edocs', 'Claim Form', true, 710, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
SELECT setval('public.document_types_admedika_id_seq', 33, true);
